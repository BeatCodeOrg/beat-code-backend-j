...
DROP DATABASE IF EXISTS `beatcode_db`;
CREATE DATABASE IF NOT EXISTS `beatcode_db`;
USE `beatcode_db`;
...
-- Table structure for table `test_cases_run`
DROP TABLE IF EXISTS `test_cases_run`;
CREATE TABLE `test_cases_run` (
  `run_case_id` int NOT NULL AUTO_INCREMENT,
  `test_case_id` int NOT NULL,
  -- NOTE THAT THIS LANGUAGE SHOULD BE THE SAME CODE AS JUDGE0
  `language` int NOT NULL,
  `prefix_to_code` varchar(500) NOT NULL,
  `suffix_to_code` varchar(500) NOT NULL,
  PRIMARY KEY (`run_case_id`),
...
INSERT INTO test_cases_run (test_case_id, language, prefix_to_code, suffix_to_code) VALUES 
(2,
62,
'',
'public class Main {
